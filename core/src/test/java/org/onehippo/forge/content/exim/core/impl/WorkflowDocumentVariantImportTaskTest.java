...
class WorkflowDocumentVariantImportTaskTest {

    private DocumentManager mockDocumentManager;
    private Session mockSession;
    private WorkflowDocumentVariantImportTask task;
    ...
    void setUp() {
        ...
        task = new WorkflowDocumentVariantImportTask(mockDocumentManager);
    }

    @Test
    void getContentNodeBindingItemFilter_whenNull_createsFilterWithDocumentExcludes() {
    ...
    @Test
    void updateDocumentFromVariantContentNode_withNullNode_throwsIllegalArgumentException() {
        ContentNode contentNode = new ContentNode();

        IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () -> {
            task.updateDocumentFromVariantContentNode(contentNode, null);
        });

        assertTrue(exception.getMessage().contains("Cannot update document"));
    }
}
