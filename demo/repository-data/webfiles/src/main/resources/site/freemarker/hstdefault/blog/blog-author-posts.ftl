...
<#-- @ftlvariable name="item" type="org.onehippo.forge.content.exim.demo.beans.Blogpost" -->
<#-- @ftlvariable name="author" type="org.onehippo.forge.content.exim.demo.beans.Author" -->
