...
@HippoEssentialsGenerated(internalName = "contenteximdemo:video")
@Node(jcrType = "contenteximdemo:video")
public class Video extends BaseDocument {
    ...
    public String getDescription() {
        return getProperty("contenteximdemo:description");
    }

    @HippoEssentialsGenerated(internalName = "contenteximdemo:link")
    public String getLink() {
        return getProperty("contenteximdemo:link");
    }
}
